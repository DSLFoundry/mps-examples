...
<solution name="mbeddr-debugger-struct-values-not-shown.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#mbeddr-debugger-struct-values-not-shown.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    <module reference="~_PreferencesModule#mbeddr-debugger-struct-values-not-shown.__spreferences.PlatformTemplates(mbeddr-debugger-struct-values-not-shown.__spreferences.PlatformTemplates)" version="0" />
  </dependencyVersions>
</solution>
