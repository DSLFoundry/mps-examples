...
<solution name="mbeddr-debugger-struct-values-not-shown.__spreferences.TypeSizeConfiguration" uuid="~_PreferencesModule#mbeddr-debugger-struct-values-not-shown.__spreferences.TypeSizeConfiguration" moduleVersion="0" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    <module reference="~_PreferencesModule#mbeddr-debugger-struct-values-not-shown.__spreferences.TypeSizeConfiguration(mbeddr-debugger-struct-values-not-shown.__spreferences.TypeSizeConfiguration)" version="0" />
  </dependencyVersions>
</solution>
