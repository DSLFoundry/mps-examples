...
<model ref="r:c1322c32-5429-4f1a-acba-0230757f94ed(com.dslfoundry.example.querylist.splitlist.editor)">
  ...
  <imports>
    <import index="empn" ref="r:fff9cd48-7c9e-4b54-897e-82d395f7aeb4(com.dslfoundry.example.querylist.splitlist.structure)" />
  </imports>
  <registry>
  ...
  <node concept="24kQdi" id="7$IgyaF0e6v">
    ...
    <node concept="3EZMnI" id="7$IgyaF0e7k" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="7$IgyaF0gEu" role="3EZMnx">
        <property role="3F0ifm" value="// The item is black colored in the list: " />
